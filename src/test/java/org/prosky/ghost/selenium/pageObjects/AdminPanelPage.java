...
public class AdminPanelPage extends Page {
	...
	public void logInAsAdmin() throws IOException {
		...
		logIn(
				System.getProperty("users.admin.email"),
				System.getProperty("users.admin.password"));
	}
	...
	public void writePost(String title, String content) {
		driver.findElement(By.id("entry-title")).sendKeys(title);
		driver.findElement(By.cssSelector("#entry-markdown-content textarea")).sendKeys(
				content);
	}
	...
	public void publishPost() throws InterruptedException {
		...
		driver.findElement(By.cssSelector("i.options.icon-arrow2")).click();
		driver.findElement(By.cssSelector("li.post-save-publish a")).click();
	...
	public void deletePost() throws InterruptedException {
		waitUntilFindElement("adminPanel.postPage.updatePostButton");
		driver.findElement(By.cssSelector("i.options.icon-arrow2")).click();
		driver.findElement(By.cssSelector("li.delete a")).click();
		waitUntilFindElement(By.xpath("//button[text()='Delete']"));
		driver.findElement(By.xpath("//button[text()='Delete']")).click();
		waitUntilFindElement(By.xpath("//span[text()='Content']"));
	}

	public WebElement findPost(String title) {
		return driver.findElement(By.xpath("//ol//li//a//h3[text()='" + title + "']"));
	}
	...
	public void logOut() {
		driver.findElement(By.className("gh-nav-menu-details")).click();
